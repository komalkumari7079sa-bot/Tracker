...
total_calories=sum(calorie-amounts)
...
if total_calories > daily_limit:
    print("Warning:Your total calorie intake exceeds your daily limits!")
else:
    print("Great! Your calorie intake is within is within the daily limit.")
